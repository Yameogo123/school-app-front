        ...
        <TouchableWithoutFeedback onPress={()=> Keyboard.dismiss()}>
            <View style={style.container}>
                ...
                <View style={style.block}>
                    <Text style={[style.text, {color: "white"}]}>Quel problème ? </Text>
                    <TextInput placeholder={"ecrire..."} inputStyle={{color:"black"}} onChangeText={setTitre}
                        {...props} textContentType="name" leading={<Ionicons name="pencil" size={25} color={chart} />} 
                    />
                </View>

                <View style={style.block}>
                    <Text style={[style.text, {color: "white"}]}>détail de l'issu </Text>
                    <TextInput placeholder={"ecrire..."} inputStyle={{color:"black"}} onChangeText={setMessage}
                        {...props} textContentType="name" leading={<Ionicons name="pencil" size={25} color={chart} />} 
                        multiline
                    />
                </View>
                ...
                <View style={[style.block, {zIndex: 1}]}>
                    <TouchableOpacity onPress={handleSend} style={[style.btn, {backgroundColor: back, borderRadius: 30, margin: 40, padding: 20}]}>
                        <Text style={[style.title, {color: "red", textAlign: "center"}]}>envoyer</Text>
                    </TouchableOpacity>
                </View>
